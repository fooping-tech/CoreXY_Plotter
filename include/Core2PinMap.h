...
// Core2 reserved pins:
// GPIO23: internal LCD SPI MOSI, GPIO21/22: internal I2C,
// GPIO1/3: USB Serial, GPIO34/35/36/38: input-only, GPIO0/2: boot straps.
// GPIO35/36 are intentionally used only as limit inputs. TMC2209 EN is
// hardwired to GND and is not controlled by an ESP32 GPIO.
constexpr uint8_t CORE2_LCD_SPI_MOSI_PIN = 23;
...
constexpr bool MOTOR_ENABLE_HARDWIRED_ACTIVE = true;
constexpr bool M5_UI_ENABLED = true;
