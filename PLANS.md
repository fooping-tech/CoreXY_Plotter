...
[docs/manual_tests.md](docs/manual_tests.md)へ移動した。
各checkの実行手順は`tools/serial_tool/docs/`の個別文書を参照。

---

# 13. Codex用プロンプト

[docs/codex_prompts.md](docs/codex_prompts.md)へ移動した(アーカイブ)。

---

# 14. リスク・未解決事項

[docs/risks.md](docs/risks.md)へ移動した。

---

# 15. 変更履歴

[CHANGELOG.md](CHANGELOG.md)へ移動した。
